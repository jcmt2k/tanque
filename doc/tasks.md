...
- [/] Crear lluvia de ácido que se dispara desde el cielo cuando un tanque recoge un powerup específico para la lluvia de ácido.
- [/] Crear efectos de sonido para la lluvia de ácido.
- [/] Crear efectos visuales para la lluvia de ácido.
- [/] Crear sistema de colisiones para la lluvia de ácido.
- [/] Crear sistema de explosión para la lluvia de ácido.
- [/] Crear lugares donde los tanques pueden protegerse de la lluvia de ácido.
