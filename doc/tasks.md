...
## Phase 6: Refactoring & Polish (Completed)

- [x] Refactor Powerups to use `POWERUP_CONFIG`
- [x] Change Yellow Powerup to Rapid Fire / Infinite Ammo
- [x] Implement UI Sidebars (Player Stats)
- [x] Implement Fullscreen Toggle (F) with correct Aspect Ratio Scaling
- [x] Fix Sprite List initialization bug (Ghost Tanks)
- [x] Add Visual Indicators for Shield and Ammo
